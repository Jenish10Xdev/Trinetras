...
export const products = [
    ...
    },
    {
        _id: "xxxx",
        name: "Raw Stones",
        description: "High quality raw stones for various purposes.",
        price: 50,
        image: [p_img1],
    ...
    {
        _id: "yyyy",
        name: "Raw Stone Trees",
        description: "Beautifully crafted trees made from raw stones.",
        price: 150,
        image: [p_img2],
        subCategory: "Raw Stone Trees",
        sizes: ["Free Size"],
        date: 1716665556559,
        bestseller: false
    }
